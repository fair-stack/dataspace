...
public class FTPServer implements Closeable {
    ...
    protected SpaceListener spaceListener = null;
    ...
    protected int PASSIVE_MIN_PORT = 1000;

    protected int PASSIVE_MAX_PORT = 50000;

    protected String IP_HOST = "127.0.0.1";
    ...
    public int getPASSIVE_MIN_PORT() {
        return PASSIVE_MIN_PORT;
    }
    ...
    public int getPASSIVE_MAX_PORT() {
        return PASSIVE_MAX_PORT;
    }

    public void setPASSIVE_MIN_PORT(int PASSIVE_MIN_PORT) {
        this.PASSIVE_MIN_PORT = PASSIVE_MIN_PORT;
    }

    public void setPASSIVE_MAX_PORT(int PASSIVE_MAX_PORT) {
        this.PASSIVE_MAX_PORT = PASSIVE_MAX_PORT;
    }
    ...
    public SpaceListener getSpaceListener() {
