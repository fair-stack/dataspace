...
import cn.cnic.dataspace.api.ftp.minimalftp.api.CommandInfo;
import cn.cnic.dataspace.api.ftp.minimalftp.api.ResponseException;
import cn.cnic.dataspace.api.ftp.minimalftp.handler.ConnectionHandler;
import cn.cnic.dataspace.api.ftp.minimalftp.handler.FileHandler;
...
public class FTPConnection implements Closeable {
     ...
     */
    /*public FileOperationHandler getFileSystem() {
     ...
     */
    public void setFileSystem(Control fs) {
