package cn.cnic.dataspace.api.datax.executor.service.logparse;
...
public class LogStatistics implements Serializable {
    ...
    /**
     * DataX task start time
     */
    private String taskStartTime;

    /**
     * End time of DataX task
     */
    private String taskEndTime;

    /**
     * Total time spent on DataX tasks
     */
    private String taskTotalTime;

    /**
     * DataX task average traffic
     */
    private String taskAverageFlow;

    /**
     * DataX record write speed
     */
    private String taskRecordWritingSpeed;

    /**
     * Total number of DataX read records
     */
    private int taskRecordReaderNum;

    /**
     * Total number of DataX read and write failures
     */
    ...
    public String toString() {
        return "LogStatistics{" + "taskStartTime=" + taskStartTime + ", taskEndTime=" + taskEndTime + ", taskTotalTime=" + taskTotalTime + ", taskAverageFlow=" + taskAverageFlow + ", taskRecordWritingSpeed=" + taskRecordWritingSpeed + ", taskRecordReaderNum=" + taskRecordReaderNum + ", taskRecordWriteFailNum=" + taskRecordWriteFailNum + '}';
    }
}
