package cn.cnic.dataspace.api.datax.core.thread;
...
import cn.cnic.dataspace.api.datax.core.util.ShardingUtil;
...
public class JobThread extends Thread {
    ...
    public void toStop(String stopReason) {
        /**
         * Thread. interrupt only supports terminating the blocking state of threads (wait, join, sleep),
         */
        this.toStop = true;
    ...
    public void run() {
        ...
        while (!toStop) {
            ...
            try {
                ...
                // Terminate operation without monitoring status temporarily
