package cn.cnic.dataspace.api.datax.rpc.remoting.provider;

import cn.cnic.dataspace.api.datax.rpc.registry.ServiceRegistry;
import cn.cnic.dataspace.api.datax.rpc.remoting.net.Server;
import cn.cnic.dataspace.api.datax.rpc.remoting.net.impl.netty.server.NettyServer;
import cn.cnic.dataspace.api.datax.rpc.remoting.net.params.BaseCallback;
...
import cn.cnic.dataspace.api.datax.rpc.util.NetUtil;
import cn.cnic.dataspace.api.datax.rpc.util.ThrowableUtil;
import cn.cnic.dataspace.api.datax.rpc.util.XxlRpcException;
...
public class XxlRpcProviderFactory {
    ...
    public void start() throws Exception {
        ...
        serverInstance.setStartedCallback(new // serviceRegistry started
        BaseCallback() {
        ...
        serverInstance.setStopedCallback(new // serviceRegistry stoped
        BaseCallback() {
