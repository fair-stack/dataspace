package cn.cnic.dataspace.api.datax.rpc.remoting.invoker.impl;
...
import cn.cnic.dataspace.api.datax.rpc.remoting.invoker.annotation.XxlRpcReference;
    ...
    public boolean postProcessAfterInstantiation(final Object bean, final String beanName) throws BeansException {
        ...
        ReflectionUtils.doWithFields(bean.getClass(), field -> {
            if (field.isAnnotationPresent(XxlRpcReference.class)) {
                ...
                logger.info(">>>>>>>>>>> xxl-rpc, invoker factory init reference bean success. serviceKey = {}, bean.field = {}.{}", XxlRpcProviderFactory.makeServiceKey(iface.getName(), rpcReference.version()), beanName, field.getName());
                // collection
