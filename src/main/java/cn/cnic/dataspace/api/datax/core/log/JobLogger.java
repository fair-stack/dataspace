package cn.cnic.dataspace.api.datax.core.log;
...
public class JobLogger {
    ...
    private static void logDetail(StackTraceElement call, String appendLog) {
        ...
        buffer.append(DateUtil.formatDateTime(new Date())).append(" ").append("[" + call.getFileName().replace("java", "") + call.getMethodName()).append("-" + call.getLineNumber() + "]").append(" ").append(appendLog != null ? appendLog : "");
